# -*- coding: utf-8 -*-
"""Scraping_documentary.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ehrYMzP0a7ji9sJsNl4ZIYNQ0Noz7ACa
"""

documentary_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/documentary.txt').readlines()
...
documentary = []
for i in range(0,len(documentary_link)):
    documentary.append(run(documentary_link[i]))

for i in range(0,25):
    c = []
    for i in range(0,len(documentary)):
        if documentary[i][0] == 'NA':
            c.append(i)

    for item in c:
        documentary[item] = (run(documentary_link[item]))
...
documentary.to_csv(os.path.join(path, r'documentary.csv'), index=False)