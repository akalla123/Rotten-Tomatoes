# -*- coding: utf-8 -*-
"""Scraping_mystery.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1MJ79vYP2rQEErkpWiltjwBlgbVrKfArp
"""

mystery_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/mystery.txt').readlines()
...
mystery = []
for i in range(0,len(mystery_link)):
    mystery.append(run(mystery_link[i]))
...
for i in range(0,25):
    ...
    for item in c:
        mystery[item] = run(mystery_link[item])
...
mystery.to_csv(os.path.join(path, r'mystery.csv'), index=False)