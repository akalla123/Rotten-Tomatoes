...
scifi_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/scifi.txt').readlines()
...
scifi = []
for i in range(0,len(scifi_link)):
    scifi.append(run(scifi_link[i]))
...
for i in range(0,25):
    ...
    for item in c:
        scifi[item] = (run(scifi_link[item]))
...
scifi.to_csv(os.path.join(path, r'scifi.csv'), index=False)