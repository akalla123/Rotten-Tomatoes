# -*- coding: utf-8 -*-
"""Scraping_horror.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jRMAfJ5ITko-PmB2F_HDqIgm-M-RCnWN
"""

horror_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/horror.txt').readlines()
...
horror = []
for i in range(0,len(horror_link)):
    horror.append(run(horror_link[i]))

for i in range(0,25):
    c = []
    for i in range(0,len(horror)):
        if horror[i][0] == 'NA':
            c.append(i)

    for item in c:
        horror[item] = (run(horror_link[item]))
...
horror.to_csv(os.path.join(path, r'horror.csv'), index=False)