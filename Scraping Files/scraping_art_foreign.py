# -*- coding: utf-8 -*-
"""Scraping_art_foreign.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Xj3kVa-g-VYlaU1ALlcb4ARmUxCEUER4
"""

art_foreign_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/art&foreign.txt').readlines()
...
art_foreign = []
for i in range(0,len(art_foreign_link)):
    art_foreign.append(run(art_foreign_link[i]))

for i in range(0,25):
    c = []
    for i in range(0,len(art_foreign)):
        if art_foreign[i][0] == 'NA':
            c.append(i)

    for item in c:
        art_foreign[item] = (run(art_foreign_link[item]))

import pandas as pd
art_foreign = pd.DataFrame(art_foreign)

import os
path= r'/Users/jaynanda/Desktop/Assignments/660/Project/Unprocessed Data'
art_foreign.to_csv(os.path.join(path, r'art_foreign.csv'), index=False)