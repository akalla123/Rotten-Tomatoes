# -*- coding: utf-8 -*-
"""Scraping_romance.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1plB4_JRXEe6S1xlvp6Q6fBB-F2fzk4dn
"""

romance_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/romance.txt').readlines()
...
romance = []
for i in range(0,len(romance_link)):
    romance.append(run(romance_link[i]))
...
for i in range(0,25):
    ...
    for item in c:
        romance[item] = run(romance_link[item])
...
romance.to_csv(os.path.join(path, r'romance.csv'), index=False)
