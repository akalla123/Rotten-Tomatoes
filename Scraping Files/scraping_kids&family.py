# -*- coding: utf-8 -*-
"""Scraping_kids&family.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10DFsIYXuyQwHVZhwgZiub-ENvmvDL78U
"""

kids_family_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/kids&family.txt').readlines()
...
kids_family = []
for i in range(0,len(kids_family_link)):
    kids_family.append(run(kids_family_link[i]))

for i in range(0,25):
    c = []
    for i in range(0,len(kids_family)):
        if kids_family[i][0] == 'NA':
            c.append(i)
  
    for item in c:
        kids_family[item] = (run(kids_family_link[item]))

import pandas as pd
kids_family = pd.DataFrame(kids_family)

import os
path= r'/Users/jaynanda/Desktop/Assignments/660/Project/Unprocessed Data'
kids_family.to_csv(os.path.join(path, r'kids_family.csv'), index=False)