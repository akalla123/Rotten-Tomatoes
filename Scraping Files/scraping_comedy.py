# -*- coding: utf-8 -*-
"""Scraping_comedy.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wWBEfLQjXOgsecx86FnL9m5BB5Pqsns9
"""

comedy_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/comedy.txt').readlines()
...
comedy = []
for i in range(0,len(comedy_link)):
    comedy.append(run(comedy_link[i]))
...
for i in range(0,25):
    ...
    for item in c:
        comedy[item] = run(comedy_link[item])
...
comedy.to_csv(os.path.join(path, r'comedy.csv'), index=False)
