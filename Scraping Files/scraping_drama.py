...
drama_link = open('/Users/jaynanda/Desktop/Assignments/660/Project/Movie Links/drama.txt').readlines()
...
for i in range(0,25):
    ...
    for item in c:
        drama[item] = (run(drama_link[item]))
...
drama.to_csv(os.path.join(path, r'drama.csv'), index=False)